...
plt.tight_layout()
plt.savefig('clustering/clustering_analysis.png')
plt.close()
...
# Save results
cluster_analysis.to_csv('clustering/cluster_analysis.csv')
rfm.to_csv('clustering/customer_segments.csv')
...
plt.savefig('clustering/customer_segments.png')
plt.close()
